...
class HashGridSolution(TorchSolution):
    name = "hashgrid_n32d6"
    description = ("champion (T=2^24, batch 524k, table LR 6e-1, Nmax=32768, batch 768k, MLP 256x6) + warmup over the "
    ...
    def __init__(self):
        self.model = HashGridNet(n_levels=12, n_features=2, log2_T=24,
                                 n_min=16, n_max=32768, hidden=256, mlp_layers=6).to(self.device)
