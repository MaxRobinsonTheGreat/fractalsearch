...
class HashGridSolution(TorchSolution):
    name = "hashgrid_n32T25"
    description = ("champion (T=2^24, batch 524k, table LR 6e-1, Nmax=32768, T=2^25) + warmup over the "
    ...
    def __init__(self):
        self.model = HashGridNet(n_levels=12, n_features=2, log2_T=25,
