...
class HashGridSolution(TorchSolution):
    name = "hashgrid_fp32"
    description = ("champion (T=2^24, batch 524k, table LR 6e-1, Nmax=32768, batch 768k) + warmup over the "
    ...
    def fit(self, ctx: FitContext) -> None:
        ...
        import contextlib
        ac = contextlib.nullcontext()  # full fp32: test if interpolation precision matters
