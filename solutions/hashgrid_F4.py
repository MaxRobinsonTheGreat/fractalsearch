...
class HashGridEncoding(nn.Module):
    def __init__(self, n_levels=16, n_features=4, log2_T=20,
                 n_min=16, n_max=4096):
        super().__init__()
...
class HashGridSolution(TorchSolution):
    name = "hashgrid_F4"
    description = "hash grid (24 lvl, F=4, T=2^21, Nmax=8192) + MLP 256x4, fresh sampling"

    def __init__(self):
        self.model = HashGridNet(n_levels=24, n_features=4, log2_T=21,
