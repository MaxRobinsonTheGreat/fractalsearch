...
class HashGridSolution(TorchSolution):
    name = "hashgrid_nmax16k"
    description = ("champion (T=2^24, batch 524k, table LR 6e-1, Nmax=16384) + warmup over the "
    ...
    def __init__(self):
        self.model = HashGridNet(n_levels=12, n_features=2, log2_T=24,
                                 n_min=16, n_max=16384, hidden=256, mlp_layers=4).to(self.device)
